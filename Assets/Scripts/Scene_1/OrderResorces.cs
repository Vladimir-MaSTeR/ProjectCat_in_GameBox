...
public class OrderResorces : MonoBehaviour, IPointerDownHandler
{
    ...
    public void OnPointerDown(PointerEventData eventData)
    {
        ...
        {
            Debug.Log("ÅÑÒÜ ÊËÈÊ ÏÎ ÏÐÅÄÌÅÒÓ");
    ...
    private void SaveTimer()
    {
        ...
        Debug.Log($"Ñîõðàíèë countSpawnOnClickName = {_currentCountSpawnOnClick}");
    ...
    private void ReloadSaveTimer()
    {
        ...
        if (PlayerPrefs.HasKey(countSpawnOnClickName))
        {
            ...
            Debug.Log($"ÇÀÃÐÓÇÈË countSpawnOnClickName = {_currentCountSpawnOnClick}");
        }
    }
