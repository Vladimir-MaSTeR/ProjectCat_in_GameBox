...
public class ButtonsController : MonoBehaviour {
    ...
    [SerializeField]
    private GameObject _resorcesPanel;
    [SerializeField]
    private GameObject _questsPanel;
    [SerializeField]
    private GameObject _mainLongTextPanel;
    [SerializeField]
    private GameObject _secondLongTextPanel;
    [SerializeField]
    private GameObject _turnHomeButtonsPanel;
    [SerializeField]
    private GameObject _sparkSopPanel;

    [SerializeField]
    private GameObject _theGameTextPanel;
    [SerializeField]
    private GameObject _autorsTextPanel;

    [Header("Алтари")]
    [Tooltip("Первый алиарь")]
    [SerializeField]
    private GameObject _altar_1;

    [Tooltip("Второй алиарь")]
    [SerializeField]
    private GameObject _altar_2;

    [Header("Текстовый поля")]
    [SerializeField]
    private Text _mainLongText;
    [SerializeField]
    private Text _secondLongText;

    [SerializeField]
    private Text _questShortText;

    [SerializeField]
    private Text _fireplaceQuestTextButton;
    [SerializeField]
    private Text _chairQuestTextButton;
    [SerializeField]
    private Text _tableQuestTextButton;

    [Header("Картинки для отслеживания заданий")]
    [SerializeField]
    private GameObject _questCheckImage_0;
    [SerializeField]
    private GameObject _questCheckImage_1;
    [SerializeField]
    private GameObject _questCheckImage_2;

    [Header("Кнопки активирования квестов")]
    [SerializeField]
    private Button _fireplaceQuestCheckButton;
    [SerializeField]
    private Button _chairQuestCheckButton;
    [SerializeField]
    private Button _tableQuestCheckButton;
    ...
    private void Start() {
        ...
        //ReloadCurrentQuest(); // СТАРОЕ СОХРАНЕНИЕ КВЕСТА
