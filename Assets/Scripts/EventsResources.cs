...
//---------------------------------------------------------------------------------------------------------------------------------
    ...
    [Tooltip("Эвент для заказа спавна предмета, передаем тег ресурса, который хотим заспавнить")]
    public static Action<string> onSpawnItem;

    [Tooltip("Эвент для заказа спавна предмета, передаем тег ресурса, " + "который хотим заспавнить и идентификатор слота в котором нужно заспавнить")]
