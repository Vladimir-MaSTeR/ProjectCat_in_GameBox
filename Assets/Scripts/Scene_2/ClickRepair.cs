...
public class ClickRepair : MonoBehaviour, IPointerClickHandler {
    ...
    [SerializeField]
    private bool loadResorces = true;
    ...
    [SerializeField]
    private bool _fireplaceActiv;
    [Tooltip("Улучшение кресло")]
    [SerializeField]
    private bool _armchairActiv;
    [Tooltip("Улучшение Кухни")]
    [SerializeField]
    private bool _kitchenActiv;
    [Tooltip("Улучшение Лестница на 2 этаж")]
    [SerializeField]
    private bool _ladderGoTo2Activ;
    [Tooltip("Улучшение кровати")]
    [SerializeField]
    private bool _bedActiv;
    [Tooltip("Улучшение Лестница на 3 этаж")]
    [SerializeField]
    private bool _ladderGoTo3Activ;
    [Tooltip("Улучшение Стол с картой")]
    [SerializeField]
    private bool _cupboardActiv;
    ...
    void IPointerClickHandler.OnPointerClick(PointerEventData eventData) {
        ...
        _activQuests();
        if(_lvObjectNow < _lvObjectMax && _checkResLvUp == true) /// проверка ресерса
        {
            _amtAddResource += 1;
    ...
    private void LoadResouces() {
        if(loadResorces) {
            ...
            if(PlayerPrefs.HasKey(_textKey + "Year")) {
                ...
                _timeAtackSpider = new DateTime(_timeAtackSpiderYear, _timeAtackSpiderMonth, _timeAtackSpiderDay, _timeAtackSpiderHour, _timeAtackSpiderMinute,
                _timeAtackSpiderSecond);
            }
        }
    }
